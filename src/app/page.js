...
export default function Home() {
  ...
  const terms = `회원가입 및 개인정보 제공 동의
고객님의 방문에 감사드립니다.

우리 매장은 개인정보보호법에 따라 고객
님의 개인정보를 보호하고 이와 관련한 고
충을 신속하고 원활하게 처리할수 있도록
하기 위하여 최소한의 개인정보를 수집하
고 있으며 다음과 같이 고객님의 동의가
필요합니다.
1.개인정보 수집 및 이용목적
① 회원가입. 회원 식별, 포인트 적립 등
기본적인 서비스 제공 및 마케칭 활용을
위하여 아래와 같이 개인정보를 수집합니
다.
- 개인정보 수집 및 활용 주체 : 투게더마
트 (TEL. 1577-4550)
- 수집항목과 이용목적
② 회원가입. 회원 식별, 포인트 적립 등
기본적인 서비스 제공 및 마케칭 활용을
